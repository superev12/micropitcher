...
namespace midiProcessor {
    static double frequencyToMidiNote(double frequencyInHz)
    {
        return 12.0*std::log2(frequencyInHz/440.0) + 69.0;
    }

    static double midiNoteToFrequency(double midiNoteNumber)
    {
        return 440 * std::pow(2, (midiNoteNumber-69)/12);
    }

    static int getMedianMidiNoteNumber(pathHelper::NodeArray nodeArray)
    {
        juce::Path path;
    ...
    static double binarySearchPath(juce::Path& path, double target, double threshold, double start, double end)
    {
    ...
    */
    static double getSemitoneDeviationAtTime(pathHelper::NodeArray nodeArray, double timeInMilliseconds)
    {
    ...
    static std::vector<double> sampleSemitoneDeviation(pathHelper::NodeArray nodeArray, float samplesPerMillisecond)
    {
    ...
    static juce::MidiMessageSequence renderNodeArrayToMidiSequence(pathHelper::NodeArray nodeArray)
    {
    ...
    static juce::MidiMessageSequence renderPathstringsToMidiSequence(std::vector<juce::String> pathStrings)
    {
