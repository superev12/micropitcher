...
void DetailsComponent::paint (juce::Graphics& g)
{
    ...
    {
        int x = (getWidth() / 2) - (200 / 2), y = 0, width = 200, height = 30;
        juce::String text (TRANS("This is the details panel"));
...
<JUCER_COMPONENT documentType="Component" className="DetailsComponent" componentName=""
  ...
  <BACKGROUND backgroundColour="ff7fff00">
    <TEXT pos="0Cc 0 200 30" fill="solid: ff000000" hasStroke="0" text="This is the details panel"
