...
struct Parameters
{
    ...
    juce::AudioParameterFloat* pan =
        new juce::AudioParameterFloat("Pan", "Pan", 0.f, 1.f, 0.5f);

    juce::AudioParameterBool* enable =
        new juce::AudioParameterBool("Enable", "Enable", true);

    juce::AudioParameterBool* thing =
        new juce::AudioParameterBool("Thing", "Thing", true);
};